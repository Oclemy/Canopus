...
interface QueryWriter
{
	 ...
	 * @param boolean $noQuotes          TRUE to NOT put backticks or users around the string
	 *
	 * @return string
	 */
...
abstract class AQueryWriter
{
	 ...
	 * @param boolean $noQuote    TRUE if you want to omit users
	 *
	 * @return array
	 */
	 ...
	 * @param boolean $noQuotes omit users
	 *
	 * @return string
	 */
...
class Facade
{
	...
	*/
	 ...
	 * @param array   $options  delimiter, user and escape character respectively
	 *
	 * @return void
	 */
